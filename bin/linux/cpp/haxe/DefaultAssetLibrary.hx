...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("graphics/snowflake.png", "graphics/snowflake.png");
		type.set ("graphics/snowflake.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
@:bitmap("/opt/haxe/lib/HaxePunk/git/assets/graphics/preloader/haxepunk.png") class __ASSET__gfx_preloader_haxepunk_png extends flash.display.BitmapData {}
@:bitmap("/opt/haxe/lib/HaxePunk/git/assets/graphics/debug/console_debug.png") class __ASSET__gfx_debug_console_debug_png extends flash.display.BitmapData {}
@:bitmap("/opt/haxe/lib/HaxePunk/git/assets/graphics/debug/console_visible.png") class __ASSET__gfx_debug_console_visible_png extends flash.display.BitmapData {}
@:bitmap("/opt/haxe/lib/HaxePunk/git/assets/graphics/debug/console_logo.png") class __ASSET__gfx_debug_console_logo_png extends flash.display.BitmapData {}
@:bitmap("/opt/haxe/lib/HaxePunk/git/assets/graphics/debug/console_play.png") class __ASSET__gfx_debug_console_play_png extends flash.display.BitmapData {}
@:bitmap("/opt/haxe/lib/HaxePunk/git/assets/graphics/debug/console_hidden.png") class __ASSET__gfx_debug_console_hidden_png extends flash.display.BitmapData {}
@:bitmap("/opt/haxe/lib/HaxePunk/git/assets/graphics/debug/console_step.png") class __ASSET__gfx_debug_console_step_png extends flash.display.BitmapData {}
@:bitmap("/opt/haxe/lib/HaxePunk/git/assets/graphics/debug/console_pause.png") class __ASSET__gfx_debug_console_pause_png extends flash.display.BitmapData {}
@:bitmap("/opt/haxe/lib/HaxePunk/git/assets/graphics/debug/console_output.png") class __ASSET__gfx_debug_console_output_png extends flash.display.BitmapData {}
@:font("/opt/haxe/lib/HaxePunk/git/assets/font/04B_03__.ttf") class __ASSET__font_04b_03___ttf extends flash.text.Font {}
