...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING(""),HX_CSTRING("Main"),HX_CSTRING("com.example.app"),HX_CSTRING("1.0.0"));
				...
				HX_STACK_CATCHABLE(Dynamic, 0);
				{
					struct _Function_3_1{
						inline static bool Block( ){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","ApplicationMain.hx",70,0x0780ded5)
							{
								HX_STACK_LINE(70)
		...
		HX_STACK_LINE(35)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)60,(int)3355443,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int(::flash::Lib_obj::VSYNC))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("project1"),null(),null());
	}
return null();
}
