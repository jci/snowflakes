...
{
HX_STACK_FRAME("openfl.AssetLibrary","new",0x1b1e281b,"openfl.AssetLibrary.new","openfl/Assets.hx",1104,0x989d477c)
HX_STACK_THIS(this)
{
}
;
...
bool AssetLibrary_obj::exists( ::String id,::openfl::AssetType type){
	HX_STACK_FRAME("openfl.AssetLibrary","exists",0xfc810d01,"openfl.AssetLibrary.exists","openfl/Assets.hx",1113,0x989d477c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
...
::flash::display::BitmapData AssetLibrary_obj::getBitmapData( ::String id){
	HX_STACK_FRAME("openfl.AssetLibrary","getBitmapData",0x8468816a,"openfl.AssetLibrary.getBitmapData","openfl/Assets.hx",1120,0x989d477c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1120)
	return null();
...
::flash::utils::ByteArray AssetLibrary_obj::getBytes( ::String id){
	HX_STACK_FRAME("openfl.AssetLibrary","getBytes",0x7785da5a,"openfl.AssetLibrary.getBytes","openfl/Assets.hx",1127,0x989d477c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1127)
	return null();
...
::flash::text::Font AssetLibrary_obj::getFont( ::String id){
	HX_STACK_FRAME("openfl.AssetLibrary","getFont",0xe6735ec0,"openfl.AssetLibrary.getFont","openfl/Assets.hx",1134,0x989d477c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1134)
	return null();
...
::flash::display::MovieClip AssetLibrary_obj::getMovieClip( ::String id){
	HX_STACK_FRAME("openfl.AssetLibrary","getMovieClip",0x2889f80f,"openfl.AssetLibrary.getMovieClip","openfl/Assets.hx",1141,0x989d477c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1141)
	return null();
...
::flash::media::Sound AssetLibrary_obj::getMusic( ::String id){
	HX_STACK_FRAME("openfl.AssetLibrary","getMusic",0xca48a294,"openfl.AssetLibrary.getMusic","openfl/Assets.hx",1148,0x989d477c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1148)
...
::String AssetLibrary_obj::getPath( ::String id){
	HX_STACK_FRAME("openfl.AssetLibrary","getPath",0xed04e696,"openfl.AssetLibrary.getPath","openfl/Assets.hx",1155,0x989d477c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1155)
	return null();
...
::flash::media::Sound AssetLibrary_obj::getSound( ::String id){
	HX_STACK_FRAME("openfl.AssetLibrary","getSound",0x3aba5ebe,"openfl.AssetLibrary.getSound","openfl/Assets.hx",1162,0x989d477c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1162)
	return null();
...
::String AssetLibrary_obj::getText( ::String id){
	HX_STACK_FRAME("openfl.AssetLibrary","getText",0xefaccd9e,"openfl.AssetLibrary.getText","openfl/Assets.hx",1167,0x989d477c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1171)
...
bool AssetLibrary_obj::isLocal( ::String id,::openfl::AssetType type){
	HX_STACK_FRAME("openfl.AssetLibrary","isLocal",0xe5a6be5c,"openfl.AssetLibrary.isLocal","openfl/Assets.hx",1194,0x989d477c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(1194)
...
{
		HX_STACK_FRAME("openfl.AssetLibrary","load",0x9dfa060b,"openfl.AssetLibrary.load","openfl/Assets.hx",1201,0x989d477c)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.AssetLibrary","loadBitmapData",0x84fddba4,"openfl.AssetLibrary.loadBitmapData","openfl/Assets.hx",1206,0x989d477c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1208)
...
{
		HX_STACK_FRAME("openfl.AssetLibrary","loadBytes",0x52a2aa60,"openfl.AssetLibrary.loadBytes","openfl/Assets.hx",1213,0x989d477c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1215)
...
{
		HX_STACK_FRAME("openfl.AssetLibrary","loadFont",0x0e76f17a,"openfl.AssetLibrary.loadFont","openfl/Assets.hx",1220,0x989d477c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1222)
...
{
		HX_STACK_FRAME("openfl.AssetLibrary","loadMovieClip",0x8eb64315,"openfl.AssetLibrary.loadMovieClip","openfl/Assets.hx",1227,0x989d477c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1229)
...
{
		HX_STACK_FRAME("openfl.AssetLibrary","loadMusic",0xa565729a,"openfl.AssetLibrary.loadMusic","openfl/Assets.hx",1234,0x989d477c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1236)
...
{
		HX_STACK_FRAME("openfl.AssetLibrary","loadSound",0x15d72ec4,"openfl.AssetLibrary.loadSound","openfl/Assets.hx",1241,0x989d477c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1243)
...
{
		HX_STACK_FRAME("openfl.AssetLibrary","loadText",0x17b06058,"openfl.AssetLibrary.loadText","openfl/Assets.hx",1248,0x989d477c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1248)
		...
		Void run(::flash::utils::ByteArray bytes){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/Assets.hx",1254,0x989d477c)
