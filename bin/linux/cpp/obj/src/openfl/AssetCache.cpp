...
{
HX_STACK_FRAME("openfl.AssetCache","new",0x4c82a362,"openfl.AssetCache.new","openfl/Assets.hx",1280,0x989d477c)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(1284)
	this->enabled = true;
...
{
		HX_STACK_FRAME("openfl.AssetCache","clear",0x1c26890f,"openfl.AssetCache.clear","openfl/Assets.hx",1298,0x989d477c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1300)
		::haxe::ds::StringMap _g = ::haxe::ds::StringMap_obj::__new();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(1300)
