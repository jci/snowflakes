...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_FRAME("StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","StringTools.hx",46,0x046ae594)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(46)
...
::String StringTools_obj::replace( ::String s,::String sub,::String by){
	HX_STACK_FRAME("StringTools","replace",0x6d651f30,"StringTools.replace","StringTools.hx",303,0x046ae594)
	HX_STACK_ARG(s,"s")
