...
{
		HX_STACK_FRAME("List","push",0xebb5efca,"List.push","List.hx",64,0xd7bcdd00)
		HX_STACK_THIS(this)
		HX_STACK_ARG(item,"item")
		HX_STACK_LINE(68)
...
Dynamic List_obj::first( ){
	HX_STACK_FRAME("List","first",0x898acc40,"List.first","List.hx",82,0xd7bcdd00)
	HX_STACK_THIS(this)
	HX_STACK_LINE(82)
	if (((this->h == null()))){
		HX_STACK_LINE(82)
...
Dynamic List_obj::last( ){
	HX_STACK_FRAME("List","last",0xe901e846,"List.last","List.hx",91,0xd7bcdd00)
	HX_STACK_THIS(this)
	HX_STACK_LINE(91)
	if (((this->q == null()))){
		HX_STACK_LINE(91)
...
Dynamic List_obj::pop( ){
	HX_STACK_FRAME("List","pop",0xed8a8da1,"List.pop","List.hx",100,0xd7bcdd00)
	HX_STACK_THIS(this)
	HX_STACK_LINE(101)
	if (((this->h == null()))){
		HX_STACK_LINE(102)
...
bool List_obj::isEmpty( ){
	HX_STACK_FRAME("List","isEmpty",0xaa565653,"List.isEmpty","List.hx",115,0xd7bcdd00)
	HX_STACK_THIS(this)
	HX_STACK_LINE(115)
	return (this->h == null());
}
...
bool List_obj::remove( Dynamic v){
	HX_STACK_FRAME("List","remove",0x4b44d634,"List.remove","List.hx",138,0xd7bcdd00)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(139)
...
Dynamic List_obj::iterator( ){
	HX_STACK_FRAME("List","iterator",0x2d4cdfde,"List.iterator","List.hx",179,0xd7bcdd00)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static Dynamic Block( hx::ObjectPtr< ::List_obj > __this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","List.hx",179,0xd7bcdd00)
			{
				...
				Dynamic run(){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","List.hx",182,0xd7bcdd00)
				...
				Dynamic run(){
					HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","List.hx",185,0xd7bcdd00)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(186)
