...
bool Circle_obj::collideMask( ::com::haxepunk::Mask other){
	...
	struct _Function_1_1{
		inline static Float Block( hx::ObjectPtr< ::com::haxepunk::masks::Circle_obj > __this){
				...
				while((true)){
					...
					if ((other->getTile(xx,yy))){
						struct _Function_6_1{
							inline static bool Block( Float &thisY,Float &hTileWidth,hx::ObjectPtr< ::com::haxepunk::masks::Circle_obj > __this,Float &dy,Float &dx,Float &thisX,Float &hTileHeight){
...
bool Circle_obj::collideHitbox( ::com::haxepunk::masks::Hitbox other){
	...
	HX_STACK_LINE(226)
	if (((((  (((other->_parent != ::com::haxepunk::Entity_obj::_EMPTY))) ? ::com::haxepunk::Entity(other->_parent) : ::com::haxepunk::Entity(null()) )) != null()))){
		HX_STACK_LINE(228)
		{
			HX_STACK_LINE(228)
			::com::haxepunk::Entity _this;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(228)
			if (((other->_parent != ::com::haxepunk::Entity_obj::_EMPTY))){
				HX_STACK_LINE(228)
				_this = other->_parent;
			}
			else{
			...
			if ((_this->followCamera)){
				HX_STACK_LINE(228)
				hx::AddEq(ox,(_this->x + ::com::haxepunk::HXP_obj::camera->x));
			}
			else{
				HX_STACK_LINE(228)
				hx::AddEq(ox,_this->x);
		...
		HX_STACK_LINE(229)
		{
			...
			if ((_this->followCamera)){
				HX_STACK_LINE(229)
				hx::AddEq(oy,(_this->y + ::com::haxepunk::HXP_obj::camera->y));
			}
			else{
				HX_STACK_LINE(229)
				hx::AddEq(oy,_this->y);
...
{
		HX_STACK_FRAME("com.haxepunk.masks.Circle","project",0xac933fbb,"com.haxepunk.masks.Circle.project","com/haxepunk/masks/Circle.hx",250,0xc8cd356d)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.haxepunk.masks.Circle","debugDraw",0xf8727959,"com.haxepunk.masks.Circle.debugDraw","com/haxepunk/masks/Circle.hx",257,0xc8cd356d)
		HX_STACK_THIS(this)
		...
		struct _Function_1_1{
			inline static Float Block( hx::ObjectPtr< ::com::haxepunk::masks::Circle_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/haxepunk/masks/Circle.hx",257,0xc8cd356d)
				{
					HX_STACK_LINE(257)
					::com::haxepunk::Entity _this = __this->_parent;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(257)
...
int Circle_obj::get_x( ){
	HX_STACK_FRAME("com.haxepunk.masks.Circle","get_x",0x45aa75b1,"com.haxepunk.masks.Circle.get_x","com/haxepunk/masks/Circle.hx",260,0xc8cd356d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(260)
...
int Circle_obj::get_y( ){
	HX_STACK_FRAME("com.haxepunk.masks.Circle","get_y",0x45aa75b2,"com.haxepunk.masks.Circle.get_y","com/haxepunk/masks/Circle.hx",261,0xc8cd356d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(261)
...
int Circle_obj::get_radius( ){
	HX_STACK_FRAME("com.haxepunk.masks.Circle","get_radius",0x2e9bcc79,"com.haxepunk.masks.Circle.get_radius","com/haxepunk/masks/Circle.hx",267,0xc8cd356d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(267)
	return this->_radius;
}
...
int Circle_obj::set_radius( int value){
	HX_STACK_FRAME("com.haxepunk.masks.Circle","set_radius",0x32196aed,"com.haxepunk.masks.Circle.set_radius","com/haxepunk/masks/Circle.hx",269,0xc8cd356d)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.haxepunk.masks.Circle","update",0x93520b67,"com.haxepunk.masks.Circle.update","com/haxepunk/masks/Circle.hx",282,0xc8cd356d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(282)
		if (((((  (((this->_parent != ::com::haxepunk::Entity_obj::_EMPTY))) ? ::com::haxepunk::Entity(this->_parent) : ::com::haxepunk::Entity(null()) )) != null()))){
			HX_STACK_LINE(285)
