...
::haxe::io::Output Sys_obj::_stderr( ){
	HX_STACK_FRAME("Sys","stderr",0x3eb04003,"Sys.stderr","Sys.hx",41,0x2741eff1)
	HX_STACK_LINE(42)
...
{
		HX_STACK_FRAME("Sys","sleep",0xfe70aad6,"Sys.sleep","Sys.hx",65,0x2741eff1)
...
::String Sys_obj::getCwd( ){
	HX_STACK_FRAME("Sys","getCwd",0xd9ded99b,"Sys.getCwd","Sys.hx",72,0x2741eff1)
	HX_STACK_LINE(73)
...
{
		HX_STACK_FRAME("Sys","setCwd",0xa6272e0f,"Sys.setCwd","Sys.hx",77,0x2741eff1)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(77)
		::Sys_obj::set_cwd(s);
	}
...
::String Sys_obj::executablePath( ){
	HX_STACK_FRAME("Sys","executablePath",0xfc9406f0,"Sys.executablePath","Sys.hx",119,0x2741eff1)
	HX_STACK_LINE(120)
