...
Void MultiVarTween_obj::tween( Dynamic object,Dynamic properties,Float duration,Dynamic ease){
{
		...
		if ((::Reflect_obj::isObject(properties))){
			HX_STACK_LINE(45)
			Array< ::String > _g = ::Reflect_obj::fields(properties);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(45)
			fields = _g;
		}
		else{
		...
		HX_STACK_LINE(52)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(54)
				a = (  (((object == null()))) ? Dynamic(null()) : Dynamic(object->__Field(p1,true)) );
				HX_STACK_LINE(56)
				if ((::Math_obj::isNaN(a))){
					HX_STACK_LINE(58)
				...
				this->_start->push(a);
				HX_STACK_LINE(62)
				Dynamic _g1 = ::Reflect_obj::field(properties,p1);		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(62)
				Float _g2 = (_g1 - a);		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(62)
				this->_range->push(_g2);
			}
		}
		HX_STACK_LINE(64)
		this->start();
...
{
		HX_STACK_FRAME("com.haxepunk.tweens.misc.MultiVarTween","update",0x1b6f556f,"com.haxepunk.tweens.misc.MultiVarTween.update","com/haxepunk/tweens/misc/MultiVarTween.hx",69,0xb94fa3b6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(70)
		this->super::update();
		HX_STACK_LINE(71)
