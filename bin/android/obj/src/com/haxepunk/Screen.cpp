...
{
HX_STACK_FRAME("com.haxepunk.Screen","new",0x20e58bd7,"com.haxepunk.Screen.new","com/haxepunk/Screen.hx",17,0x08128799)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(260)
...
{
		HX_STACK_FRAME("com.haxepunk.Screen","init",0xa4ad87b9,"com.haxepunk.Screen.init","com/haxepunk/Screen.hx",30,0x08128799)
		HX_STACK_THIS(this)
		HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("com.haxepunk.Screen","refresh",0x9d5b1cd2,"com.haxepunk.Screen.refresh","com/haxepunk/Screen.hx",107,0x08128799)
		HX_STACK_THIS(this)
		HX_STACK_LINE(109)
...
int Screen_obj::set_color( int value){
	HX_STACK_FRAME("com.haxepunk.Screen","set_color",0x56e0e87d,"com.haxepunk.Screen.set_color","com/haxepunk/Screen.hx",149,0x08128799)
	HX_STACK_THIS(this)
...
int Screen_obj::set_x( int value){
	HX_STACK_FRAME("com.haxepunk.Screen","set_x",0x2f406292,"com.haxepunk.Screen.set_x","com/haxepunk/Screen.hx",160,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(161)
	if (((this->x == value))){
...
int Screen_obj::set_y( int value){
	HX_STACK_FRAME("com.haxepunk.Screen","set_y",0x2f406293,"com.haxepunk.Screen.set_y","com/haxepunk/Screen.hx",172,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(173)
	if (((this->y == value))){
...
int Screen_obj::set_originX( int value){
	HX_STACK_FRAME("com.haxepunk.Screen","set_originX",0xe5d9814c,"com.haxepunk.Screen.set_originX","com/haxepunk/Screen.hx",184,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(185)
...
int Screen_obj::set_originY( int value){
	HX_STACK_FRAME("com.haxepunk.Screen","set_originY",0xe5d9814d,"com.haxepunk.Screen.set_originY","com/haxepunk/Screen.hx",196,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(197)
...
Float Screen_obj::set_scaleX( Float value){
	HX_STACK_FRAME("com.haxepunk.Screen","set_scaleX",0x2389aa34,"com.haxepunk.Screen.set_scaleX","com/haxepunk/Screen.hx",208,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(209)
...
Float Screen_obj::set_scaleY( Float value){
	HX_STACK_FRAME("com.haxepunk.Screen","set_scaleY",0x2389aa35,"com.haxepunk.Screen.set_scaleY","com/haxepunk/Screen.hx",222,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(223)
...
Float Screen_obj::set_scale( Float value){
	HX_STACK_FRAME("com.haxepunk.Screen","set_scale",0x855345a4,"com.haxepunk.Screen.set_scale","com/haxepunk/Screen.hx",237,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(238)
	if (((this->scale == value))){
...
Float Screen_obj::get_angle( ){
	HX_STACK_FRAME("com.haxepunk.Screen","get_angle",0x4c15cee1,"com.haxepunk.Screen.get_angle","com/haxepunk/Screen.hx",266,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_LINE(266)
...
Float Screen_obj::set_angle( Float value){
	HX_STACK_FRAME("com.haxepunk.Screen","set_angle",0x2f66baed,"com.haxepunk.Screen.set_angle","com/haxepunk/Screen.hx",268,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(269)
...
bool Screen_obj::get_smoothing( ){
	HX_STACK_FRAME("com.haxepunk.Screen","get_smoothing",0x96d2ff82,"com.haxepunk.Screen.get_smoothing","com/haxepunk/Screen.hx",281,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_LINE(281)
	if (((::com::haxepunk::HXP_obj::renderMode == ::com::haxepunk::RenderMode_obj::BUFFER))){
		HX_STACK_LINE(283)
...
bool Screen_obj::set_smoothing( bool value){
	HX_STACK_FRAME("com.haxepunk.Screen","set_smoothing",0xdbd8e18e,"com.haxepunk.Screen.set_smoothing","com/haxepunk/Screen.hx",291,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(292)
	if (((::com::haxepunk::HXP_obj::renderMode == ::com::haxepunk::RenderMode_obj::BUFFER))){
...
int Screen_obj::get_mouseX( ){
	HX_STACK_FRAME("com.haxepunk.Screen","get_mouseX",0xaff46bc5,"com.haxepunk.Screen.get_mouseX","com/haxepunk/Screen.hx",317,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_LINE(317)
...
int Screen_obj::get_mouseY( ){
	HX_STACK_FRAME("com.haxepunk.Screen","get_mouseY",0xaff46bc6,"com.haxepunk.Screen.get_mouseY","com/haxepunk/Screen.hx",323,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_LINE(323)
...
::com::haxepunk::graphics::Image Screen_obj::capture( ){
	HX_STACK_FRAME("com.haxepunk.Screen","capture",0x578c137d,"com.haxepunk.Screen.capture","com/haxepunk/Screen.hx",331,0x08128799)
	HX_STACK_THIS(this)
	HX_STACK_LINE(331)
	if (((::com::haxepunk::HXP_obj::renderMode == ::com::haxepunk::RenderMode_obj::BUFFER))){
		HX_STACK_LINE(333)
			...
			if (((::com::haxepunk::HXP_obj::renderMode == ::com::haxepunk::RenderMode_obj::HARDWARE))){
				...
				struct _Function_4_1{
					inline static ::com::haxepunk::graphics::atlas::AtlasData Block( ::flash::display::BitmapData &bd){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/haxepunk/Screen.hx",333,0x08128799)
						{
							HX_STACK_LINE(333)
