...
HX_STACK_ARG(clipRect,"clipRect")
{
			...
			switch( (int)(_g->__Index())){
				case (int)0: {
					...
					HX_STACK_LINE(85)
					{
						...
						this->_source = bitmap;
						HX_STACK_LINE(88)
						::flash::geom::Rectangle _g4 = bitmap->get_rect();		HX_STACK_VAR(_g4,"_g4");
						HX_STACK_LINE(88)
				...
				case (int)1: {
					...
					HX_STACK_LINE(89)
					{
						...
						this->_region = region;
						HX_STACK_LINE(92)
						::flash::geom::Rectangle _g5 = ::flash::geom::Rectangle_obj::__new((int)0,(int)0,this->_region->_rect->width,this->_region->_rect->height);		HX_STACK_VAR(_g5,"_g5");
						HX_STACK_LINE(92)
	...
	if ((this->blit)){
		HX_STACK_LINE(109)
		::flash::display::Bitmap _g7 = ::flash::display::Bitmap_obj::__new(null(),null(),null());		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(109)
		this->_bitmap = _g7;
		HX_STACK_LINE(110)
		::flash::geom::ColorTransform _g8 = ::flash::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(110)
...
{
		HX_STACK_FRAME("com.haxepunk.graphics.Image","render",0x93d8c8f3,"com.haxepunk.graphics.Image.render","com/haxepunk/graphics/Image.hx",141,0xdb117b4e)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.haxepunk.graphics.Image","renderAtlas",0xc015a358,"com.haxepunk.graphics.Image.renderAtlas","com/haxepunk/graphics/Image.hx",174,0xdb117b4e)
		HX_STACK_THIS(this)
		...
		if (((this->angle == (int)0))){
			...
			HX_STACK_LINE(199)
			{
				...
				HX_STACK_LINE(199)
				{
						...
						if (((::com::haxepunk::graphics::atlas::AtlasData_obj::active != _this1))){
							...
							if (((::com::haxepunk::graphics::atlas::AtlasData_obj::active != null()))){
								...
								if (((_this2->_dataIndex != (int)0))){
									...
									HX_STACK_LINE(199)
									_this2->_tilesheet->drawTiles(_g,_this2->_data,::com::haxepunk::graphics::atlas::Atlas_obj::smooth,_this2->_renderFlags,_this2->_dataIndex);
									HX_STACK_LINE(199)
					...
					HX_STACK_LINE(199)
					int _g1 = (_this1->_dataIndex)++;		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(199)
					_this1->_data[_g1] = this->_point->x;
					HX_STACK_LINE(199)
					int _g2 = (_this1->_dataIndex)++;		HX_STACK_VAR(_g2,"_g2");
					HX_STACK_LINE(199)
					_this1->_data[_g2] = this->_point->y;
					HX_STACK_LINE(199)
					int _g3 = (_this1->_dataIndex)++;		HX_STACK_VAR(_g3,"_g3");
					HX_STACK_LINE(199)
					_this1->_data[_g3] = _this->tileIndex;
					HX_STACK_LINE(199)
					if (((angle == (int)0))){
						HX_STACK_LINE(199)
						int _g4 = (_this1->_dataIndex)++;		HX_STACK_VAR(_g4,"_g4");
						HX_STACK_LINE(199)
						_this1->_data[_g4] = scaleX;
						HX_STACK_LINE(199)
						int _g5 = (_this1->_dataIndex)++;		HX_STACK_VAR(_g5,"_g5");
						HX_STACK_LINE(199)
						_this1->_data[_g5] = (int)0;
						HX_STACK_LINE(199)
						int _g6 = (_this1->_dataIndex)++;		HX_STACK_VAR(_g6,"_g6");
						HX_STACK_LINE(199)
						_this1->_data[_g6] = (int)0;
						HX_STACK_LINE(199)
						int _g7 = (_this1->_dataIndex)++;		HX_STACK_VAR(_g7,"_g7");
						HX_STACK_LINE(199)
						_this1->_data[_g7] = scaleY;
					}
					else{
						HX_STACK_LINE(199)
			...
			HX_STACK_LINE(224)
			{
				...
				if ((_this->rotated)){
						...
						HX_STACK_LINE(224)
						{
							...
							if (((::com::haxepunk::graphics::atlas::AtlasData_obj::active != _this1))){
								...
								if (((::com::haxepunk::graphics::atlas::AtlasData_obj::active != null()))){
									...
									if (((_this2->_dataIndex != (int)0))){
										HX_STACK_LINE(224)
										::flash::display::Graphics _g16 = ::com::haxepunk::graphics::atlas::AtlasData_obj::_scene->sprite->get_graphics();		HX_STACK_VAR(_g16,"_g16");
										HX_STACK_LINE(224)
										_this2->_tilesheet->drawTiles(_g16,_this2->_data,::com::haxepunk::graphics::atlas::Atlas_obj::smooth,_this2->_renderFlags,_this2->_dataIndex);
										HX_STACK_LINE(224)
										_this2->_dataIndex = (int)0;
									}
								}
					...
					HX_STACK_LINE(224)
					{
						...
						if (((::com::haxepunk::graphics::atlas::AtlasData_obj::active != _this1))){
							...
							if (((::com::haxepunk::graphics::atlas::AtlasData_obj::active != null()))){
								...
								if (((_this2->_dataIndex != (int)0))){
									HX_STACK_LINE(224)
									::flash::display::Graphics _g28 = ::com::haxepunk::graphics::atlas::AtlasData_obj::_scene->sprite->get_graphics();		HX_STACK_VAR(_g28,"_g28");
									HX_STACK_LINE(224)
									_this2->_tilesheet->drawTiles(_g28,_this2->_data,::com::haxepunk::graphics::atlas::Atlas_obj::smooth,_this2->_renderFlags,_this2->_dataIndex);
									HX_STACK_LINE(224)
									_this2->_dataIndex = (int)0;
								}
							}
					...
					HX_STACK_LINE(224)
					_this1->_data[_g29] = tx;
					HX_STACK_LINE(224)
					int _g30 = (_this1->_dataIndex)++;		HX_STACK_VAR(_g30,"_g30");
					HX_STACK_LINE(224)
					_this1->_data[_g30] = ty;
					HX_STACK_LINE(224)
					int _g31 = (_this1->_dataIndex)++;		HX_STACK_VAR(_g31,"_g31");
					HX_STACK_LINE(224)
					_this1->_data[_g31] = _this->tileIndex;
					HX_STACK_LINE(224)
					int _g32 = (_this1->_dataIndex)++;		HX_STACK_VAR(_g32,"_g32");
					HX_STACK_LINE(224)
					_this1->_data[_g32] = a;
					HX_STACK_LINE(224)
...
Float alpha = __o_alpha.Default(1);
	HX_STACK_FRAME("com.haxepunk.graphics.Image","createRect",0x1a3ffe5d,"com.haxepunk.graphics.Image.createRect","com/haxepunk/graphics/Image.hx",237,0xdb117b4e)
		...
		if (((::com::haxepunk::HXP_obj::renderMode == ::com::haxepunk::RenderMode_obj::HARDWARE))){
			...
			HX_STACK_LINE(245)
			{
				...
				struct _Function_3_1{
					inline static ::com::haxepunk::graphics::atlas::AtlasData Block( ::flash::display::BitmapData &source){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/haxepunk/graphics/Image.hx",245,0xdb117b4e)
						{
							HX_STACK_LINE(245)
			...
			struct _Function_2_1{
				inline static ::com::haxepunk::ds::Either Block( ::flash::display::BitmapData &source){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/haxepunk/graphics/Image.hx",249,0xdb117b4e)
					{
						HX_STACK_LINE(249)
...
int color = __o_color.Default(16777215);
Float alpha = __o_alpha.Default(1);
	HX_STACK_FRAME("com.haxepunk.graphics.Image","createCircle",0x811fa389,"com.haxepunk.graphics.Image.createCircle","com/haxepunk/graphics/Image.hx",266,0xdb117b4e)
		...
		if (((::com::haxepunk::HXP_obj::renderMode == ::com::haxepunk::RenderMode_obj::HARDWARE))){
			...
			HX_STACK_LINE(279)
			{
				...
				struct _Function_3_1{
					inline static ::com::haxepunk::graphics::atlas::AtlasData Block( ::flash::display::BitmapData &data){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/haxepunk/graphics/Image.hx",279,0xdb117b4e)
						{
							HX_STACK_LINE(279)
			...
			struct _Function_2_1{
				inline static ::com::haxepunk::ds::Either Block( ::flash::display::BitmapData &data){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/haxepunk/graphics/Image.hx",283,0xdb117b4e)
					{
						HX_STACK_LINE(283)
						::com::haxepunk::graphics::atlas::AtlasData _g3;		HX_STACK_VAR(_g3,"_g3");
						struct _Function_3_1{
...
int thick = __o_thick.Default(1);
	HX_STACK_FRAME("com.haxepunk.graphics.Image","createPolygon",0x976a1ae1,"com.haxepunk.graphics.Image.createPolygon","com/haxepunk/graphics/Image.hx",302,0xdb117b4e)
...
{
		HX_STACK_LINE(303)
		::flash::display::Graphics graphics = ::com::haxepunk::HXP_obj::sprite->get_graphics();		HX_STACK_VAR(graphics,"graphics");
		HX_STACK_LINE(304)
		...
		HX_STACK_LINE(320)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(320)
				::flash::geom::Point p1 = points->__get(_g6).StaticCast< ::flash::geom::Point >();		HX_STACK_VAR(p1,"p1");
				HX_STACK_LINE(320)
				++(_g6);
				HX_STACK_LINE(322)
				if (((p1->x < minX))){
		...
		if ((fill)){
			...
			HX_STACK_LINE(337)
			graphics->lineStyle(thick,color,alpha,false,::flash::display::LineScaleMode_obj::NORMAL,null(),::flash::display::JointStyle_obj::MITER,null());
		}
		HX_STACK_LINE(340)
		graphics->moveTo(points->__get((points->length - (int)1)).StaticCast< ::flash::geom::Point >()->x,points->__get((points->length - (int)1)).StaticCast< ::flash::geom::Point >()->y);
		HX_STACK_LINE(341)
		{
			HX_STACK_LINE(341)
			int _g6 = (int)0;		HX_STACK_VAR(_g6,"_g6");
		...
		HX_STACK_LINE(350)
		::flash::display::BitmapData data = ::com::haxepunk::HXP_obj::createBitmap(w,h,true,(int)0);		HX_STACK_VAR(data,"data");
		HX_STACK_LINE(351)
		...
		if (((::com::haxepunk::HXP_obj::renderMode == ::com::haxepunk::RenderMode_obj::HARDWARE))){
			...
			HX_STACK_LINE(356)
			{
				...
				struct _Function_3_1{
					inline static ::com::haxepunk::graphics::atlas::AtlasData Block( ::flash::display::BitmapData &data){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/haxepunk/graphics/Image.hx",356,0xdb117b4e)
						{
							HX_STACK_LINE(356)
							::com::haxepunk::graphics::atlas::AtlasData data1 = ::com::haxepunk::graphics::atlas::AtlasData_obj::__new(data,null(),null());		HX_STACK_VAR(data1,"data1");
							HX_STACK_LINE(356)
			...
			struct _Function_2_1{
				inline static ::com::haxepunk::ds::Either Block( ::flash::display::BitmapData &data){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/haxepunk/graphics/Image.hx",360,0xdb117b4e)
					{
						HX_STACK_LINE(360)
